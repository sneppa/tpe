...
public class BTreeClass implements BTree, Serializable {
    ...
    /**
     * Writes current object into file
     * @param file filename
    ...
    /**
     * Reads file into current object
     * @param file filename
     * @return boolean successfull?
     */
    public boolean readFromFile(String file) {
        try {
            ...
            // Writes stream into object
            BTreeClass btree = (BTreeClass) in.readObject();
            // change the current vars of the object
            this.nodeSize = btree.nodeSize;
            this.order = btree.order;
